...
import type { INodeExecutionData, ITaskData, Result, WebhookResponseData } from 'workflow';
import { BINARY_ENCODING, createResultError, createResultOk, OperationalError } from 'workflow';
