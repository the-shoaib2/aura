...
export const PLAYGROUND_4: WorkflowDataCreate = {
	...
	nodes: [
		...
		},
		{
			...
			type: 'aura-nodes-base.aggregate',
			typeVersion: 1,
			position: [688, -192],
		...
		},
		{
			parameters: {
				content:
					'**Tip: Use credentials**\nAdd [credentials](https://docs.aura.io/credentials) in aura to connect apps like Gmail, Slack, or OpenAI and use them in your workflows.',
				height: 112,
				width: 288,
				color: 5,
			},
