...
export const PLAYGROUND_1: WorkflowDataCreate = {
	...
	nodes: [
		...
		},
		{
			parameters: {
				content:
					'**Tip: Ressources**\n- Use the `aura Assistant` or any LLM like `ChatGPT` to explain a screenshot, fix issues, or create workflows for you\n- Learn and get inspired with [templates](https://aura.io/workflows/)\n- Follow the [aura Courses](https://docs.aura.io/courses/) or find tutorials on Youtube\n- Ask [the community](https://community.aura.io/) for help \n',
				height: 176,
				width: 400,
				color: 5,
			},
