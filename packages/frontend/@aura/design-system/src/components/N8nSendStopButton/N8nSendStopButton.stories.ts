...
const AllSizesTemplate: StoryFn = () => ({
	...
	template: `
		<div style="display: flex; flex-direction: column; gap: 20px;">
			<div style="display: flex; align-items: center; gap: 20px;">
				<aura-send-stop-button size="mini" @send="onSend" />
				<span style="color: var(--color--text)">Mini</span>
			</div>
			<div style="display: flex; align-items: center; gap: 20px;">
				<aura-send-stop-button size="small" @send="onSend" />
				<span style="color: var(--color--text)">Small</span>
			</div>
			<div style="display: flex; align-items: center; gap: 20px;">
				<aura-send-stop-button size="medium" @send="onSend" />
				<span style="color: var(--color--text)">Medium</span>
			</div>
			<div style="display: flex; align-items: center; gap: 20px;">
				<aura-send-stop-button size="large" @send="onSend" />
	...
	template: `
		<div style="display: grid; grid-template-columns: repeat(2, 200px); gap: 20px;">
			<div style="text-align: center;">
				<aura-send-stop-button :streaming="false" :disabled="false" />
				<p style="color: var(--color--text); margin-top: 10px;">Send (Enabled)</p>
			</div>
			<div style="text-align: center;">
				<aura-send-stop-button :streaming="false" :disabled="true" />
				<p style="color: var(--color--text); margin-top: 10px;">Send (Disabled)</p>
			</div>
			<div style="text-align: center;">
				<aura-send-stop-button :streaming="true" :disabled="false" />
