...
.el-button {
	@include Button.aura-button(true);
	...
	&.el-color-dropdown__link-btn {
		@include Button.aura-button-secondary;
	}
}
</style>
...
.highlight {
	@include Button.aura-button-highlight;
}
...
.success {
	@include Button.aura-button-success;
}

.warning {
	@include Button.aura-button-warning;
}

.danger {
	@include Button.aura-button-danger;
}
