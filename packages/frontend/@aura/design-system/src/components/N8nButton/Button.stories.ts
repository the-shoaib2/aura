...
const AllColorsAndSizesTemplate: StoryFn = (args, { argTypes }) => ({
	...
	template: `<div>
		...
		<aura-button v-bind="args" size="large" type="highlight" @click="onClick" />
		<br/>
		<br/>
		...
		<aura-button v-bind="args" size="medium" type="highlight" @click="onClick" />
		<br/>
		<br/>
		...
		<aura-button v-bind="args" size="small" type="highlight" @click="onClick" />
	</div>`,
	methods,
});
