...
const mockSuggestions: WorkflowSuggestion[] = [
	{
		...
		prompt:
			'Create an invoice parsing workflow using aura forms. Extract key information and store in Airtable.',
	},
	{
		id: 'ai-news-digest',
...
RichTextMessage.args = {
	...
	messages: getMessages([
		...
		},
		{
			...
			type: 'text',
			role: 'assistant',
			content: 'Hello Kobi! How can I assist you with aura today?',
			read: true,
		},
		{
			id: '21514129',
		...
		},
		{
			...
			role: 'assistant',
			content:
				"I'm glad you found the information helpful! If you have any more questions about aura or need further assistance, feel free to ask.",
			read: true,
		},
		{
			id: '2556642',
...
const SEARCH_FILES_TOOL_CALL_ERROR_2: ChatUI.AssistantMessage = {
	...SEARCH_FILES_TOOL_CALL_COMPLETED,
	status: 'error',
	customDisplayTitle: 'Searching for aura node',
};
