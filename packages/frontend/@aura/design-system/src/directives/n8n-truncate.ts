...
/**
 * Custom directive `auraTruncate` to truncate text content of an HTML element.
 *
 * Usage:
 * In your Vue template, use the directive `v-aura-truncate` with an argument to specify the length to truncate to.
 *
 * Example:
 * <p v-aura-truncate:10="'Some long text that will be truncated'" />
 *
...
export const auraTruncate: FunctionDirective<HTMLElement, string> = (
	el: HTMLElement,
