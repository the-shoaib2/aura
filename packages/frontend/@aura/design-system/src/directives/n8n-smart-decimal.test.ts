		...
		const { html } = render(
			{
				...
				template: '<p v-aura-smart-decimal="text" />',
			},
			{
				props: {
					text: '42',
		...
		const { html } = render(
			{
				...
				template: '<p v-aura-smart-decimal:3="text" />',
			},
			{
				props: {
					text: '42',
		...
		const { html } = render(
			{
				...
				template: '<p v-aura-smart-decimal:1="text">',
			},
			{
				props: {
					text: '42.123456',
		...
		const { html } = render(
			{
				...
				template: '<p v-aura-smart-decimal:5="text" />',
			},
			{
				props: {
					text: '0.000567',
