...
import type { ISupplyDataFunctions, IWorkflowDataProxyData, NodeConnectionType } from 'workflow';
import { ApplicationError, NodeConnectionTypes, NodeOperationError } from 'workflow';
