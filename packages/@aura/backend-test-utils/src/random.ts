...
import { randomInt, randomString, UPPERCASE_LETTERS } from 'workflow';
import type { ICredentialDataDecryptedObject } from 'workflow';
...
export const randomApiKey = () => `aura_api_${randomString(40)}`;
